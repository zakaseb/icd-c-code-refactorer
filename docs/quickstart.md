...
Set `AGENTIC_PIPELINE=0` to force the classic sequential path. Sandbox build retries remain configurable in the UI when that control is present on your checkout.
