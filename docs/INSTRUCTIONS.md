...
- **Agentic multi-agent mission** (`api/agentic_pipeline/`): MissionController, six teams, blackboard, Claude Agent SDK → local LLM (default on this branch via `AGENTIC_PIPELINE=1`)
